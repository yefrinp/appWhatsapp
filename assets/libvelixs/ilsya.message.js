...
$("select[name='message_type']").on('change', function () {
    ...
    switch (value) {
        case "text":
            html += '<div class="col-12"><div class="mb-3"><label class="form-label">Message</label><textarea name="message" rows="6" class="form-control" placeholder="Example : {{Hai|Hello}} {name}, your number is {number} registered at velixs.com" required></textarea></div></div>';
            break;
        case "media":
            html += '<div class="col-12 col-xl-6 col-lg-6"><div class="mb-3"><label class="form-label">Media</label><div class="input-group"><input type="text" class="form-control" name="media" placeholder="Example : {{Hai|Hello}} {name}, your number is {number} registered at velixs.com" required><button class="btn btn-primary waves-effect filemanagerilsya" type="button">Upload</button></div></div></div>';
        ...
        case "list":
            ...
            html += '<div class="col-12"><div class="mb-3"><label class="form-label">Message</label><textarea name="message" placeholder="Example : {{Hai|Hello}} {name}, your number is {number} registered at velixs.com" rows="6" class="form-control" required></textarea></div></div>';
            html += '<div class="col-12"><div class="mb-3"><label class="form-label">Footer</label><input name="footer" class="form-control" required autocomplete="off"></div></div>';
